...
// Async thunk to Fetch Products and optional Filter
export const fetchProductsByFilter = createAsyncThunk(
  ...
  async ({
    ...
    if (flavour) query.append("flavour", flavour);
...
const productSlice = createSlice({
  ...
  initialState: {
    ...
    loading: false, // Store the loading state
    error: null, // Store the error state
    filters: {
      category: "",
      flavour: "",
      brand: "",
